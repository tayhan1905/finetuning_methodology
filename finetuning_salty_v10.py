"""
finetuning_salty_v10.py  —  SALTEDORA-V4 (Fixed Energy Cuts, r=128) vs Full Fine-Tuning
========================================================================================
...
Outputs
-------
results_v10/bert-base-uncased/full_ft/reference/glue_sst2/
    results.json  |  loss_per_batch.csv  |  loss_per_epoch.csv
    weights/epoch_<n>.pt  …  final.pt

results_v10/bert-base-uncased/saltedora_v4_cut_<X>/r_64/glue_sst2/
    results.json  |  loss_per_batch.csv  |  loss_per_epoch.csv
    weights/epoch_<n>.pt  …  final.pt

results_v10/principal_angles/cut_<X>/
    final_comparison_summary.csv
    epoch_trajectory_summary.csv
    <layer>_trajectory_angles.npz

results_v10/summary_v10_energy_cuts.csv
"""
...
if __name__ == "__main__":
    ...
    out_csv    = f"{RESULTS_ROOT}/summary_v10_energy_cuts.csv"
