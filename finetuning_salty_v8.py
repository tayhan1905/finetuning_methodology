...
=========================================================================
Trains SALTEDORA-V4 with cumulative energy knee split (rank 128) and full
...
Outputs
-------
results_v8/bert-base-uncased/full_ft/reference/glue_sst2/
    results.json  |  loss_per_batch.csv  |  loss_per_epoch.csv
    weights/epoch_<n>.pt  …  final.pt

results_v8/bert-base-uncased/saltedora_v4_knee/r_64/glue_sst2/
    results.json  |  loss_per_batch.csv  |  loss_per_epoch.csv
    weights/epoch_<n>.pt  …  final.pt

results_v8/principal_angles/
    final_comparison_summary.csv
    epoch_trajectory_summary.csv
    <layer>_trajectory_angles.npz

results_v8/summary_v8.csv
"""
...
if __name__ == "__main__":
    ...
    summary.to_csv(f"{RESULTS_ROOT}/summary_v8.csv", index=False)
    logger.info(f"\n✅ Done. Summary → {RESULTS_ROOT}/summary_v8.csv")
